...
public class FineTuneDPOMethodHyperparameters {
  ...
  public enum BetaEnum {
    ...
    @JsonCreator
    public static BetaEnum fromValue(String input) {
      for (BetaEnum b : BetaEnum.values()) {
  ...
  private BetaEnum beta = BetaEnum.AUTO;
  ...
  public FineTuneDPOMethodHyperparameters beta(BetaEnum beta) {
    this.beta = beta;
    return this;
  }
   ...
   * @return beta
  **/
  public BetaEnum getBeta() {
    return beta;
  }

  public void setBeta(BetaEnum beta) {
    this.beta = beta;
  }

  public FineTuneDPOMethodHyperparameters batchSize(BatchSizeEnum batchSize) {
  ...
  **/
  ...
  public FineTuneDPOMethodHyperparameters learningRateMultiplier(LearningRateMultiplierEnum learningRateMultiplier) {
  ...
  **/
  ...
  public FineTuneDPOMethodHyperparameters nEpochs(NEpochsEnum nEpochs) {
